...
public class CustomerServlet extends HttpServlet {
    ...
    private void listCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("listCustomer", listCustomer);  // chưa hiểu setAttribute
        RequestDispatcher dispatcher = request.getRequestDispatcher("customer/index.jsp"); // chưa hiểu RequestDispatcher
    ...
    private void deleteCustomerById(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect("/"); // chưa hiểu sendRedirect
    }
